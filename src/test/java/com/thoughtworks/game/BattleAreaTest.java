...
import com.thoughtworks.game.exception.InvalidBattleAreaException;
import com.thoughtworks.game.exception.InvalidShipCoordinatesException;
import com.thoughtworks.game.exception.InvalidShipCountException;
...
public class BattleAreaTest {
	...
	public void Should_ThrowException_When_TotalBattleShipsNotWithinDefinedRange(){
		int min=1, max = 10;
		BattleArea battleArea = new BattleArea(5, 'Z');
		battleArea.addAllShips(min, max, 11);
	}
	...
	public void Should__AddTotalBattleShips_When_AddShip(){
		int min=1, max = 10;
		BattleArea battleArea = new BattleArea(5, 'Z');
		Ship[] ship = battleArea.addAllShips(min, max, 5);
